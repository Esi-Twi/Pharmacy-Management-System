...
function PharmaSideNav({isOpen, closeSidebar }) {
 ...
 <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${
                      ...
                      >
                        <ul className="mt-2 ml-8 space-y-1">
                          {item.submenu.map((subItem, index) => (
                            <li key={index}>
                              <button
                                onClick={() => { handleNavigation(subItem.link); setActiveItem(subItem.label) }}
